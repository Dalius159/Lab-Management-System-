function MultiSelectTag(e, t = { shadow: !1, rounded: !0 }) {
    var l = null, n = null, a = null, d = null, s = null, o = null, i = null, r = null,
        c = null, u = null, v = null, p = null, h = t.tagColor || {};
    ...
    function L() {
        for (var e of p.children) {
            e.addEventListener("click", (e) => {
                if (!1 === n.find((t) => t.value == e.target.dataset.value).selected) {
    ...
    window.addEventListener("click", (e) => {
        if (!a.contains(e.target)) {
            if ("LI" !== e.target.nodeName && "input_checkbox" !== e.target.getAttribute("class")) {
                v.classList.add("hidden");
            } else {
                L();
            }
